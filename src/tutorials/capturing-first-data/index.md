...
2. Tap the **Create project** button in the **Home** tab
   ![Mergin Maps mobile app Home tab Create project](./merginmaps-mobile-home-tab-of-projects-screen.webp "Mergin Maps mobile app Create project")
...
3. Enter the **name** of your project and press **Create project**. You might need to minimise the on-screen keyboard to see this button.
   ![Create project in Mergin Maps mobile app](./merginmaps-mobile-create-new-project.webp "Create project button in Mergin Maps mobile app")
...
![Created project listed in the home tab](./merginmaps-mobile-new-project-listed.webp "Created project listed in the home tab")
...
1. Open the project by tapping its row in the **Projects** screen. 
   ...
   ![Current location shown on OpenStreetMap](./merginmaps-mobile-location-shown-on-osm.webp "Current location shown on OpenStreetMap")
...
2. Pinch the map to zoom in to your current position. If needed, recentre the map using the **GPS** button in the bottom right corner of the screen.
   ![Mergin Maps mobile app Record button](./merginmaps-mobile-location-zoom.webp "Mergin Maps mobile app Record button")
...
4. To add a new feature, press **Add**. 
   ...
   ![Capturing point in Mergin Maps mobile app](./merginmaps-mobile-default-point-position.webp "Capturing point in Mergin Maps mobile app")
...
5. A survey form opens. 
   ...
   ![Attributes form (left) and taking photo (right)](./merginmaps-mobile-entering-attributes.webp "Attributes form (left) and taking photo (right)")

6. Press **Save** when you're happy with the details you've entered:
   ![Save feature with filled attributes form](./merginmaps-mobile-save-feature.webp "Save feature with filled attributes form")
...
7. The feature you just captured should now be visible on the map.
   ...
   ![Surveyed feature visible on the map](./merginmaps-mobile-new-feature-on-map.webp "Surveyed feature visible on the map")
