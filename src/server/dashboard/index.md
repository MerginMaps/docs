...
![Open Admin panel from the dashboard](./dashboard-admin-panel.webp "Open Admin panel from the dashboard")
...
![Server administration panel overview](./admin-panel-overview.webp "Server administration panel overview")
...
![Server administration panel overview](./admin-panel-accounts.webp "Server administration panel overview")
...
![Server administration panel overview](./admin-panel-account-details.webp "Server administration panel overview")
...
![Server administration panel Add user](./admin-panel-accounts-add-user.webp "Server administration panel Add user")
3. Fill in the details: first name, email and password.
![Server administration panel Create new user](./admin-panel-accounts-create-new-user.webp "Server administration panel Create new user")
...
![Server administration panel Projects](./admin-panel-projects.webp "Server administration panel Projects")
...
![Server administration panel Project details](./admin-panel-project-detail.webp "Server administration panel Project details")
...
![Server administration panel Workspaces](./admin-panel-workspaces.webp "Server administration panel Workspaces")
...
![Server administration panel Workspace details](./admin-panel-workspace-details.webp "Server administration panel Workspace details")

### How to create a new workspace

1. Navigate to the **Workspaces** tab and click on the **Create workspace** button
   ![Server administration panel - create new workspace](./admin-panel-workspaces-create-workspace.webp "Server administration panel - create new workspace")

2. Fill in the name of the workspace and **Save changes**.
![Server administration panel - create new workspace](./admin-panel-workspaces-create-workspace-form.webp "Server administration panel - create new workspace")
...
![Server administration panel Settings](./admin-panel-settings.webp "Server administration panel Settings")
