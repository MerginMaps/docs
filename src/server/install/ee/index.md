...
![Create AWS account](./create_aws_account.webp "Create AWS account")
...
![Login as root to AWS](./root_login.webp "Login as root to AWS")

- Create an IAM user by searching in the console “IAM” and creating a new user. 
 
![Create IAM user](./create_IAM_user.webp "Create IAM user") 

- Assign the IAM user administrator account permissions. Look for <NoSpellcheck id="AdministratorAccess" /> permission.
 
![Assign AWS permissions](./assign_permissions.webp "Assign AWS permissions") 

- Review and add it to your new IAM user account

![Finish assigning AWS permissions](./assign_permission_2.webp "Finish assigning AWS permissions") 
...
![Login as IAM user to AWS](./login_IAM.webp "Login as IAM user to AWS")

- Now create CLI access key

![Create access keys](./create_access_key.webp "Create access keys")

- Note down ACCESS_ID and SECRET for AWS command line client

![Console login details](./find_name_and_id.webp "Console login details")
...
![Docker pull of Mergin Maps EE image](./docker_pull.webp "Docker pull of Mergin Maps EE image")
