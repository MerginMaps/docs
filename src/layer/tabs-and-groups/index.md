...
1. Click on the **+** button to add new group or a tab to the form layout
   ![QGIS Drag and drop designer add new group or tab](./qgis-form-layout-add-groups-tabs.webp "Add new group or tab button")
2. Choose the container type, add a label, and if needed, the number of columns.
   ...
   ![QGIS form Add tab](./qgis-add-group-tab.webp "QGIS form Add tab")
   ![QGIS form Add group](./qgis-form-add-group.webp "QGIS form Add group")
...
![QGIS form with tabs and groups](./qgis_forms_layout.webp "QGIS form with tabs and groups")

The form with tabs and groups will appear in QGIS like this:
![QGIS form layout with tabs and groups](./qgis-form-tabs-groups.webp "QGIS form layout with tabs and groups")

And this is how the same form looks like in the <MobileAppNameShort />:
![Mergin Maps mobile form with tabs and groups](./mobile-forms-layout.webp "Mergin Maps mobile form with tabs and groups")
