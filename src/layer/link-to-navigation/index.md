...
Attributes forms can include clickable links that can be used to [open a navigation app](#open-link-to-a-navigation-app) directly from the form in <MobileAppName />.  
