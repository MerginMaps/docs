...
- **Read**: users will be able to view the project data and [history](../howto/manage/web/project-details.md)
...
- **Read**: users will be able to view the list of project, projects data and [history](../howto/manage/web/project-details.md)
