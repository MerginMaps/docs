...
3. In the <MainPlatformName /> tab, check the **Enable map sketching** option.
   ![Enable map sketching in QGIS Mergin Maps project](../../gis/features/project-map-sketching.webp "Enable map sketching in QGIS Mergin Maps project")
...
1. Tap the **Map sketching** button
   ![Map sketching button in Mergin Maps mobile app](./mobile-map-sketching-button.webp "Map sketching button in Mergin Maps mobile app")
...
2. The **Sketch** bar appears.
   ...
   ![Map sketches in Mergin Maps mobile app](./mobile-map-sketching.webp "Map sketches in Mergin Maps mobile app")

   - Made a mistake? Use the **Eraser** button to remove your sketches.
   ![Erase map sketches in Mergin Maps mobile app](./mobile-map-sketching-eraser.webp "Erase map sketches button in Mergin Maps mobile app")
...
4. Sync your changes to <MainPlatformNameLink />.
   ...
   ![Map sketches in Mergin Maps project in QGIS](./qgis-map-sketching.webp "Map sketches in Mergin Maps project in QGIS")
