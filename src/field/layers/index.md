...
![Layers in Mergin Maps mobile app](./mobile-app-non-spatial-layers.webp "Layers in Mergin Maps mobile app")
...
![Mergin Maps mobile app Layers visibility](./mobile-app-layers-off.webp "Mergin Maps mobile app Layers visibility")
...
1. Open your <MainPlatformName /> project in QGIS
   ![Layer order setup in QGIS Mergin Maps project](./qgis-layer-order.webp "Layer order setup in QGIS Mergin Maps project")
...
3. In the <MainPlatformName /> tab, choose the sort method: *Alphabetical* or *QGIS layer order*.
   ![Layer order setup in QGIS Mergin Maps project](../../gis/features/project-layer-order.webp "Layer order setup in QGIS Mergin Maps project")
...
5. Open the project in the <MobileAppNameShort />.
   ...
   ![Layer order setup in Mergin Maps mobile app](./mobile-app-layer-order.webp "Layer order setup in Mergin Maps mobile app")
...
![Mergin Maps mobile app Layers legend and features](./mobile-app-layers.webp "Layers legend and features")
...
![Layers overview in Mergin Maps mobile app](../mobile-app-ui/mobile-app-layers.webp "Layers overview in Mergin Maps mobile app")
...
![Mergin Maps mobile app browse data](./mobile-app-search-data.webp "Mergin Maps mobile app browse data")
