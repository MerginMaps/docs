...
To open the measurement tools, tap the **More** button in the bottom navigation panel and use the **Measure** option.
   ![Mergin Maps mobile app Measurement tools](./mobile-measure.webp "Mergin Maps mobile app Measurement tools")
...
![Mergin Maps mobile app measuring length and area](./mobile-measure-length-area.webp "Mergin Maps mobile app measuring length and area")
...
![QGIS length and area units setup](./qgis-project-properties-set-units.webp "QGIS length and area units setup")

Now, the <MobileAppNameShort /> displays the length/the perimeter in feet and the area in acres.
![Mergin Maps mobile app measuring length and area in feet and acres](./mobile-measure-length-area-ft-ac.webp "Mergin Maps mobile app measuring length and area in feet and acres")
