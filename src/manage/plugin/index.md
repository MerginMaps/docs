...
![Mergin Maps Plugin Toolbar in QGIS](../../setup/install-mergin-maps-plugin-for-qgis/mergin-toolbar.webp "Mergin Maps Plugin Toolbar in QGIS")
...
- the <MainPlatformName />  logo is a shortcut to <AppDomainNameLink />
  ![A link to the Mergin Maps dashboard](./plugin-toolbar-logo.webp "A link to the Mergin Maps dashboard")
...
- **Configure <MainPlatformName /> plugin** to [configure plugin](../../setup/install-mergin-maps-plugin-for-qgis/#plugin-configuration) to connect to <MainPlatformName /> or [a custom server](../../server/plugin-mobile-app/)
  ...
  ![](./plugin-configure.webp "")
  
- **Create <MainPlatformName /> project** to [create or package a QGIS project](../create-project/#create-a-project-in-qgis)
  ![Create Mergin Maps project button](./plugin-toolbar-create-project.webp "Create Mergin Maps project button")
  ![Create Mergin Maps project options](../create-project/mergin_plugin_project_wizard_2.webp "Create Mergin Maps project options")
...
- **Synchronise <MainPlatformName /> project** to inspect and [synchronise](../synchronisation/#synchronising-changes-in-qgis) or reset changes made in the current project
  ![Synchronise changes button](./plugin-toolbar-sync.webp "Synchronise changes button")
  ![Mergin Maps project status with pending changes](./plugin-project-status.webp "Mergin Maps project status with pending changes")

- **Project history** to inspect [project history and versions](../project-history/)
  ![Project history button](./plugin-toolbar-project-history.webp "Project history button")
  ![Project history changes viewer](./plugin-history-viewer.webp "Project history changes viewer")
...
![List of Mergin Maps projects in QGIS Browser](./plugin-browser-projects.webp "List of Mergin Maps projects in QGIS Browser")
...
![Mergin Maps in QGIS browser](./plugin-browser.webp "Mergin Maps in QGIS browser")
...
1. Right-click on a project in the Browser panel and select **Download**
   ![Download Mergin Maps project option in QGIS browser](../../tutorials/opening-surveyed-data-on-your-computer/qgis-download-project.webp "Download Mergin Maps project option in QGIS browser")
...
1. Right-click on the <MainPlatformName /> entry in the QGIS Browser and select the **Explore public projects** option
   ![Explore public projects in QGIS Browser](./plugin-explore-public-projects.webp "Explore public projects in QGIS Browser")

2. Find the project you are interested in. Use the search bar to limit the choices.
   ![List of public projects in QGIS Browser](./plugin-explore-public-projects-list.webp "List of public projects in QGIS Browser")
...
![Mergin Maps Project Properties in QGIS](./qgis-mergin-maps-project-properties.webp "Mergin Maps Project Properties in QGIS")

![Mergin Maps Project Properties in QGIS](./qgis-mergin-maps-project-properties-2.webp "Mergin Maps Project Properties in QGIS")
...
![Mergin Maps tools in QGIS processing toolbox](./plugin-processing.webp "Mergin Maps tools in QGIS processing toolbox")
...
2. Double click the **Create diff** tool and fill in the parameters in the dialog window. Click **Run**.
   ![Create diff tool dialog](./plugin-create-diff.webp "Create diff tool dialog")
...
3. The diff layer is added to the **Layers** panel. Changes are visualised on the map and also in the attribute table of the layer.
   ![Diff layer added to QGIS layers panel](./plugin-create-diff-map.webp "Diff layer added to QGIS layers panel")
...
2. Double click the **Create report** tool. 
   ...
   Click **Run**.
   ![Create report tool dialog](./plugin-create-report.webp "Create report tool dialog")

3. The report is added to the **Layers** panel.
   ![Create report tool result](./plugin-report.webp "Create report tool result")
...
2. Double click the **Extract local changes** tool. In the dialog window, enter your project directory and select the input layer. The output local changes layer can be saved as a file or as a temporary file. Click **Run**.
   ![QGIS extract local changes tool](./plugin-extract-local-changes.webp "QGIS extract local changes tool")

3. The local changes layer is added to the **Layers** panel
   ![Local changes added to QGIS project](./plugin-extract-local-changes-layer.webp "Local changes added to QGIS project")
...
![Mergin Maps in QGIS Plugins menu bar](./plugins-menu-bar.webp "Mergin Maps in QGIS Plugins menu bar")
