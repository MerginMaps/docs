...
![Mergin Maps dashboard](./mergin-maps-dashboard.webp "Mergin Maps dashboard")
...
![Mergin Maps dashboard projects tab](./mergin-maps-dashboard-projects.webp "Mergin Maps dashboard projects tab")
...
![Mergin Maps dashboard project details](./mergin-maps-project-details.webp "Mergin Maps dashboard project details")
...
![Detail of a file in Mergin Maps project](./mergin-maps-dashboard-file-detail.webp "Detail of a file in Mergin Maps project")
...
![Project history in Mergin Maps dashboard](./mergin-maps-dashboard-project-history.webp "Project history in Mergin Maps dashboard")

You can click on a specific version to see more details.

![Project version details in Mergin Maps dashboard](./mergin-maps-dashboard-project-history-version.webp "Project version details in Mergin Maps dashboard")
...
![Mergin Maps project collaborators](./mergin-maps-dashboard-project-collaborators.webp "Mergin Maps project collaborators")
...
![Project settings in Mergin Maps Dashboard](./mergin-maps-dashboard-project-settings.webp "Project settings in Mergin Maps Dashboard")
...
![Mergin Maps dashboard workspace members](./mergin-maps-dashboard-members.webp "Mergin Maps dashboard workspace members")
...
![Mergin Maps Subscriptions details](./mergin-maps-dashboard-subscriptions.webp "Mergin Maps Subscriptions details")
...
![Mergin Maps subscription management portal](../subscriptions/stripe-merginmaps-subcription.webp "Mergin Maps subscription management portal")
...
![Mergin dashboard web workspace settings](./mergin-maps-dashboard-settings.webp "Mergin Maps dashboard workspace settings")

## User profile
**Your profile** can be accessed by clicking on the user name in the upper right corner.

![Mergin Maps dashboard user profile](./mergin-maps-dashboard-profile.webp "Mergin Maps dashboard user profile") 
...
![Mergin Maps dashboard account details](./mergin-maps-dashboard-profile-details.webp "Mergin Maps dashboard account details")
...
![Mergin Maps dashboard manage workspaces](./mergin-maps-dashboard-manage-workspaces.webp "Mergin Maps dashboard manage workspaces")
...
![Mergin Maps web workspaces overview](./mergin-maps-dashboard-workspaces.webp "Mergin Maps web workspaces overview")
