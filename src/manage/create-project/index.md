...
2. Click on **Create Mergin Maps Project** from the toolbar.
   ![Create project icon in Mergin Maps QGIS plugin](../../tutorials/creating-a-project-in-qgis/qgis-create-mergin-project.webp "Create project icon in Mergin Maps QGIS plugin")

3. There are three options available (the last two options are available only if you have an existing project open):
   ![Create Mergin Maps project options](./mergin_plugin_project_wizard_2.webp "Create Mergin Maps project options")
   ...
   - **Package current QGIS project**. This option will create a copy of your project and all the files in a single folder. There are three options for handling layers: package, keep as is (the layer will be referenced as is in the new project) or ignore (the layer will not be included in the new project). For more details, see [<MainPlatformName /> project](../project/#packaging-qgis-project).
     ![New Mergin Maps project Package current QGIS project](./mergin_plugin_project_wizard_3.webp "New Mergin Maps project - Package current QGIS project")
...
4. Change the workspace (if needed), name the project and select a path where your project folder and associated files will be generated.
   ...
   ![New Mergin Maps project name and folder](./mergin_plugin_project_wizard_4.webp "New Mergin Maps project name and folder")
...
2. Find the project you want to clone. Right-click on it and select **Clone**.
   ...
   ![Clone Mergin Maps project in QGIS](./plugin-clone.webp "Clone Mergin Maps project in QGIS")

3. Select the **workspace** from the drop-down menu and enter your new **Project Name**. Click **OK**.
   ![Clone Mergin Maps project in QGIS](./clone.webp "Clone Mergin Maps project in QGIS")
...
2. Navigate to the **Home** tab and tap **Create project**
   ![Create project in Mergin Maps mobile app](./mobile-app-create-project.webp "Create project in Mergin Maps mobile app")

3. Give the project a name. Keep in mind that the name cannot be changed later.

   Press **Create project**.
   ![Mergin Maps mobile app new project name](./mobile-app-create-project-name-fields.webp "Mergin Maps mobile app new project name")

4. Your new project will be created locally on your mobile device
   ![Mergin Maps mobile app home projects](./mobile-app-new-project-created.webp "Mergin Maps mobile app home projects")
   
5. To save it to the <MainPlatformNameLink /> server, tap the **Upload** option
   ![Uploading Mergin Maps project to the cloud](./mobile-app-upload-project-to-the-cloud.webp "Uploading Mergin Maps project to the cloud")

6. The project is now uploaded to your current workspace and can be shared across devices or with other users
   ![Mobile app project uploaded to the cloud](./mobile-app-project-workspace.webp "Mobile app project uploaded to the cloud")
...
2. In the **Projects** tab, click on **Create project**
   ![Create Mergin Maps project through dashboard](./dashboard-create-project.webp "Create Mergin Maps project through dashboard")

3. Enter a **Project name** and click **Create project**
   ![Mergin Maps dashboard create new project](./dashboard-new-project.webp "Mergin Maps dashboard create new project")
...
4. Now you will be directed to the project overview.
   ...
   ![Upload files to Mergin Maps project](./dashboard-upload-new-project.webp "Upload files to Mergin Maps project")
...
1. In the **Projects** tab, find the project you want to clone, open it and click on **Clone**.
   ...
   ![Mergin Maps dashboard Cloning project from your workspace](./dashboard-clone-project.webp "Mergin Maps dashboard - Cloning project from your workspace")
...
2. Enter the name of the cloned project. If needed, change the target workspace.
   ...
   ![Naming cloned project](./dashboard-clone-project-name.webp "Naming cloned project")
...
1. In the **Projects** tab, click on the **Browse community projects** button
   ![Mergin Maps dashboard browse community projects](./dashboard-browse-public-projects.webp "Mergin Maps dashboard browse community projects")
...
2. You will see a list of public projects. Use the search bar to find a project you would like to clone and click on it.
   ![Find public Mergin Maps projects](./dashboard-find-public-project.webp "Find public Mergin Maps projects")

3. When the project's page opens, click on the **Clone** button to clone the project.
   ![Clone public Mergin Maps project](./dashboard-clone-public-project.webp "Clone public Mergin Maps project")
   
4. Now you can change the project's name and select the target workspace. Confirm by clicking **Clone project**.

   The cloned project will be saved to the workspace you have specified.
   ![Clone public Mergin Maps project](./dashboard-clone-public-project-name.webp "Clone public Mergin Maps project")
