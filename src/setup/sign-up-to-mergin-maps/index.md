...
2. Use the **Sign Up** link to navigate to the registration form. 
   ...
   ![Mergin Maps sign up form](./dashboard-sign-up.webp "Mergin Maps sign up form")
...
4. Now your account needs a [workspace](../../manage/workspaces/)! 
   ...
   ![Create workspace in Mergin Maps](./create-workspace.webp "Create workspace in Mergin Maps")
...
2. Now you have the option to **join workspace** you were invited to
   ![Join workspace in Mergin Maps](./join-workspace.webp "Join workspace in Mergin Maps")
...
2. Open the <MobileAppNameShort />. Tap the account icon in the upper right corner to go to the login page. 
   ![Mergin Maps mobile app account icon](./mobile-app-account-icon.webp "Mergin Maps mobile app account icon")
   
3. Tap on **Sign up**
   ![Mergin Maps mobile app sign up](./mobile-app-sign-up.webp "Mergin Maps mobile app sign up")
...
4. Fill up the form and tap on **Sign up** to create your account.
   ...
   Check your spam folder if the confirmation email does not appear in your inbox after 5 minutes.   
   ![Mergin Maps mobile app register](./mobile-app-sign-up-form.webp "Mergin Maps mobile app register")
...
5. Every account needs to have a [workspace](../../manage/workspaces/) for storing projects. Choose an appropriate name for your workspace and tap on the **Create workspace** button.
   ...
   ![Create workspace in Mergin Maps mobile app](./mobile-app-create-workspace.webp "Create workspace in Mergin Maps mobile app")
...
![Mergin Maps dashboard single sign-on](./dashboard-sso-sign-up.webp "Mergin Maps dashboard single sign-on")
...
2. Tap the **Continue with SSO** option
   ![Mergin Maps mobile app single sign-on](./mobile-sso-sign-in.webp "Mergin Maps mobile app single sign-on")
...
2. On the toolbar, click on the **Configure <MainPlatformName /> plugin** button
   ![Configure Mergin Maps Plugin](../install-mergin-maps-plugin-for-qgis/qgis-configure-mergin-plugin.webp "Configure Mergin Maps Plugin")
3. Use the **Continue with SSO** option to open SSO sign in
   ![Mergin Maps QGIS plugin single sign-on](./plugin-sso-sign-in.webp "Mergin Maps QGIS plugin single sign-on")
